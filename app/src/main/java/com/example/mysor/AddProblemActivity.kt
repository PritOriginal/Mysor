...
class AddProblemActivity : AppCompatActivity(), SeekBar.OnSeekBarChangeListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        trashLevel = findViewById(R.id.trash_level)
    ...
    fun addLabels() {
        ...
        // Добавление метки
           var addLabel = AddLabel(this, adapter.getPhotos(), description.text.toString(), type, (seekBar.progress / 28 + 1).toFloat())
           addLabel.execute()
    }
    ...
    override fun onProgressChanged(p0: SeekBar?, p1: Int, p2: Boolean) {
        ...
        trashLevel.setImageResource(pollutionIcon[seekBar.progress / 28])
    }
